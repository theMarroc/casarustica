...
export function DatosTransferencia({
  ...
  return (
    <div className="rounded-marca border border-acento/50 bg-acento/12 p-6">
      ...
      {filas.length === 0 ? (
        <p className="mt-4 rounded-marca border border-alerta/40 bg-white px-4 py-3 text-sm text-alerta-oscura">
  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-marca bg-white px-4 py-2.5">
      ...
      <button
        ...
        className="flex shrink-0 items-center gap-1.5 rounded-marca border border-piedra/40 px-2.5 py-1.5 text-[10px] font-semibold uppercase tracking-[0.1em] text-nogal transition-colors hover:border-acento-fuerte hover:text-acento-fuerte"
