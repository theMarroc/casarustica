...
export function EditorItemsCombo({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {items.length > 0 ? (
        <ul className="divide-y divide-piedra/20 rounded-marca border border-piedra/30">
          {items.map((item) => {
            const producto = buscar(item.product_id);
            return (
              <li
              ...
              >
                <span className="min-w-32 flex-1 text-sm text-carbon/85">
                  ...
                  {producto ? (
                    <span className="ml-2 text-xs text-piedra-oscura">
        ...
        <p className="rounded-marca border border-dashed border-piedra/50 bg-lino/60 px-4 py-6 text-center text-sm text-piedra-oscura">
      ...
      {items.length > 0 ? (
        <p className="rounded-marca bg-lino px-4 py-2.5 text-sm text-carbon/75">
