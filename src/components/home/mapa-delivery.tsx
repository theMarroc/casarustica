      ...
      <div className="contenedor grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          <ul className="mt-8 flex flex-col gap-4 text-sm text-carbon/75">
            ...
            {retiro ? (
              <li className="flex items-start gap-3">
                <MapPin className="mt-0.5 h-5 w-5 shrink-0 text-acento-fuerte" strokeWidth={1.4} />
                <span>
        ...
        <div className="overflow-hidden rounded-marca border border-piedra/30 bg-arena/20 shadow-suave">
          {mapa ? (
            <iframe
              src={mapa}
            ...
            <div
              className="flex h-80 flex-col items-center justify-center gap-3 px-6 text-center lg:h-96"
              style={{
                background:
                  "radial-gradient(90% 80% at 50% 45%, var(--color-hueso) 0%, var(--color-lino) 55%, var(--color-arena) 130%)",
              }}
            >
              <MapPin className="h-10 w-10 text-madera" strokeWidth={1.2} />
              <p className="font-script text-4xl leading-none text-nogal">Miramar</p>
              <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-piedra-oscura">
