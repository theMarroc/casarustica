...
export function FormularioContacto({ whatsapp }: { whatsapp: string }) {
  ...
  return (
    <form
      ...
      className="flex flex-col gap-4 rounded-marca border border-piedra/30 bg-white p-6 shadow-suave"
    >
      ...
      <p className="text-center text-xs leading-relaxed text-piedra-oscura">
