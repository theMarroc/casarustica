...
export function Pie({
  ...
  return (
    <footer className="mt-24 border-t border-piedra/25 bg-lino">
      <div className="contenedor grid gap-10 py-14 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-5 text-[11px] uppercase tracking-[0.2em] text-piedra-oscura">
            {ajuste(ajustes, "marca_claim")}
          </p>
        </div>

        <div>
          <h3 className="mb-4 font-sans text-[11px] font-semibold uppercase tracking-[0.14em] text-nogal">
            Comprar
          </h3>
          <ul className="flex flex-col gap-2.5 text-sm text-carbon/70">
            <li>
              <Link href="/tienda" className="transition-colors hover:text-acento-fuerte">
                Todos los productos
              </Link>
            </li>
            ...
            <li>
              <Link href="/sets" className="transition-colors hover:text-acento-fuerte">
                Sets y kits
              </Link>
            </li>
          </ul>
          ...
          <ul className="flex flex-col gap-2.5 text-sm text-carbon/70">
            <li>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 transition-colors hover:text-acento-fuerte"
              >
          ...
          <div className="mt-5 flex gap-2">
            {instagram ? (
              <a
                ...
                className="rounded-marca border border-piedra/40 p-2 text-nogal transition-colors hover:border-acento-fuerte hover:text-acento-fuerte"
              >
      ...
      <div className="border-t border-piedra/25 py-5">
        <div className="contenedor flex flex-col items-center justify-between gap-3 text-xs text-piedra-oscura sm:flex-row">
          <p>
          ...
          <div className="flex gap-5">
            ...
            <Link href="/contacto" className="transition-colors hover:text-nogal">
              Contacto
            </Link>
            <Link href="/mi-cuenta" className="transition-colors hover:text-nogal">
              Mi cuenta
            </Link>
          </div>
        </div>
...
export function BotonWhatsapp({ ajustes }: { ajustes: Settings }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-30 flex h-13 w-13 items-center justify-center rounded-full bg-salvia text-white shadow-tarjeta transition-transform hover:scale-105"
    >
