...
export const metadata: Metadata = {
  title: "Tienda",
  description: "Bandejas, latas, cartelería, tejidos y souvenirs hechos a mano en Miramar.",
};
    ...
    <>
      <CabeceraPagina
        ...
        texto={
          ...
          "Cada pieza se pinta y se termina a mano. Si buscás algo que no está en la lista, escribinos: muchas se hacen a pedido."
        }
        migas={
          categoriaActual
      ...
      <div className="contenedor py-10 lg:py-14">
        <div className="mb-8 flex flex-col gap-4">
            ...
            <Link
              ...
              className={cn(
                ...
                !categoria && oferta !== "1"
                  ...
                  : "border-piedra/45 text-carbon/70 hover:border-carbon hover:text-carbon",
              )}
            >
              Todo
            </Link>
            ...
            <Link
              ...
              className={cn(
                ...
                oferta === "1"
                  ...
                  : "border-acento-fuerte/50 text-acento-profundo hover:bg-acento-fuerte/10",
              )}
            >
              En oferta
            </Link>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-t border-piedra/25 pt-4">
            <p className="text-sm text-piedra-oscura">
              {ordenados.length}{" "}
              {ordenados.length === 1 ? "producto" : "productos"}
              {q ? (
                <>
                  {" "}
                  para <span className="font-semibold text-nogal">&ldquo;{q}&rdquo;</span>{" "}
