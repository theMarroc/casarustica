  ...
  return (
    <>
      ...
      <section className="contenedor grid gap-10 py-12 lg:grid-cols-2 lg:gap-16 lg:py-16">
        <div>
          <h2 className="font-display text-2xl text-nogal">Por dónde encontrarnos</h2>
          ...
          <ul className="mt-6 flex flex-col gap-5 text-sm">
            <li>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-start gap-3 text-carbon/80 transition-colors hover:text-acento-fuerte"
              >
            ...
            {email ? (
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-carbon/80 transition-colors hover:text-acento-fuerte"
                >
                  <Mail className="mt-0.5 h-5 w-5 shrink-0 text-acento-fuerte" strokeWidth={1.4} />
                  <span>
                    <span className="block font-semibold text-nogal">Email</span>
                    {email}
                  </span>
                </a>
              </li>
            ...
            <li className="flex items-start gap-3 text-carbon/80">
              ...
              <span>
                <span className="block font-semibold text-nogal">Zona de entrega</span>
