...
export default async function PaginaNosotros() {
  ...
  const imagen = ajusteCrudo(ajustes, "nosotros_imagen") || ajusteCrudo(ajustes, "hero_imagen");
  ...
  return (
    <>
      ...
      <section className="contenedor grid items-center gap-10 py-14 lg:grid-cols-2 lg:gap-16">
        <div className="relative aspect-4/5 overflow-hidden rounded-marca bg-arena/25">
          {imagen ? (
            <Image
              src={imagen}
              alt=""
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(120% 90% at 30% 20%, var(--color-hueso) 0%, var(--color-lino) 45%, var(--color-arena) 100%)",
              }}
            >
        ...
        <div>
          <h2 className="titulo-seccion text-nogal">
            {ajuste(ajustes, "nosotros_subtitulo")}{" "}
            <span className="cursiva-marca">
              {ajuste(ajustes, "nosotros_subtitulo_cursiva")}
            </span>
          </h2>
