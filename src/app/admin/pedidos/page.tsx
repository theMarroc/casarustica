...
export default async function PedidosAdmin({
  ...
  return (
    <>
      ...
      {borrado ? (
        <p className="mb-5 flex items-center gap-2 rounded-marca border border-salvia/40 bg-salvia/10 px-4 py-3 text-sm text-salvia">
                ...
                <li key={pedido.id}>
                  ...
                  >
                    <div className="min-w-40 flex-1">
                      <p className="flex flex-wrap items-center gap-2 font-mono text-sm font-semibold tracking-wider text-nogal">
                        {pedido.code}
                        {pedido.receipt_path ? (
                          <span title="Tiene comprobante">
                            <FileCheck className="h-4 w-4 text-salvia" strokeWidth={1.6} />
                          </span>
                        ) : null}
                      </p>
