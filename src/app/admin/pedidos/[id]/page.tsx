      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_20rem]">
        <div className="flex flex-col gap-6">
          ...
          <PanelAdmin titulo="Datos de la entrega">
              ...
              {pedido.delivery_type === "delivery" ? (
                <>
                  ...
                  <FilaDato etiqueta="Indicaciones">
                    {pedido.address_notes ?? "Sin indicaciones"}
                  </FilaDato>
                </>
              ) : null}
            ...
            {pedido.notes ? (
              <p className="mt-4 rounded-marca bg-lino px-4 py-3 text-sm leading-relaxed text-carbon/80">
                <span className="font-semibold text-nogal">Nota del cliente: </span>
                {pedido.notes}
              </p>
            ) : null}
          </PanelAdmin>
          ...
          <PanelAdmin titulo="Comprobante" className="h-fit">
            {urlComprobante ? (
              <>
                ...
                <p className="mt-3 text-xs leading-relaxed text-piedra-oscura">
