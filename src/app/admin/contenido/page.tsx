        ...
        >
          <FormularioAdmin accion={guardarAjustes}>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <CampoConEtiqueta
                etiqueta="Frase de la franja de color"
        ...
        <PanelAdmin titulo="Página Nosotros">
          <FormularioAdmin accion={guardarAjustes}>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <CampoConEtiqueta etiqueta="Subtítulo">
                <Campo
                  name="ajuste_nosotros_subtitulo"
                  defaultValue={ajuste(ajustes, "nosotros_subtitulo")}
                />
              </CampoConEtiqueta>

              <CampoConEtiqueta etiqueta="Subtítulo en cursiva">
                <Campo
                  name="ajuste_nosotros_subtitulo_cursiva"
                  defaultValue={ajuste(ajustes, "nosotros_subtitulo_cursiva")}
                />
              </CampoConEtiqueta>
              ...
              <div className="sm:col-span-2">
                <SubidorImagen
                  nombre="ajuste_nosotros_imagen"
                  carpeta="nosotros"
                  etiqueta="Foto de Nosotros"
                  ayuda="Una foto tuya o del taller. Si no subís ninguna, se usa la de la portada."
                  valorInicial={ajusteCrudo(ajustes, "nosotros_imagen")}
                />
              </div>
            </div>
          </FormularioAdmin>
        ...
        <PanelAdmin titulo="Preguntas frecuentes">
          <div className="flex flex-col gap-3">
            {preguntas.map((pregunta) => (
              <div
                key={pregunta.id}
                className="rounded-marca border border-piedra/25 bg-lino/40 p-3"
              >
