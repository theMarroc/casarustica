      ...
      <div className="flex flex-col gap-6">
        ...
        <PanelAdmin className="p-0! sm:p-0!">
          <div className="px-5 pb-5 pt-5 sm:px-6 sm:pt-6">
            <h2 className="font-display text-xl text-nogal">Cambiar un precio suelto</h2>
          ...
          {productos.length === 0 ? (
            ...
            <ul className="divide-y divide-piedra/20 border-t border-piedra/20">
              ...
              {[...lotes.entries()].map(([loteId, lote]) => (
                ...
                >
                  <div className="min-w-48 flex-1">
                    <p className="flex flex-wrap items-center gap-2 text-sm font-semibold text-nogal">
                      {lote.motivo}
                      {lote.revertido ? (
